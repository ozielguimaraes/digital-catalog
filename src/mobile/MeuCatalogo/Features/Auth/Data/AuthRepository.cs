    ...
    : IAuthRepository
{
    ...
    public async Task<ApiResponse<SigninResponse>> SigninAsync(SigninRequest request, CancellationToken ct = default)
    {
        ...
        var favorito = response.Dados.CatalogoFavorito is null
            ? null
            : new CatalogoInfo
            {
        ...
        settingsService.CatalogoFavorito = favorito;
        settingsService.CatalogoEmUso = favorito;
    ...
    public async Task LogoutAsync(CancellationToken ct = default)
    {
        ...
        settingsService.CatalogoEmUso = null;
