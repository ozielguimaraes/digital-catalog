#!/usr/bin/env python3
"""
Script Python para deploy automático via FTP
Mais robusto e confiável que scripts shell
"""
...
def main():
    ...
    print_message("📋 Lembre-se de descompactar o ZIP no servidor", Colors.YELLOW)
    
    print_message("\n📋 Para descompactar no servidor:", Colors.YELLOW)
    ...
    print_message("3. Navegue até public_html", Colors.YELLOW)
